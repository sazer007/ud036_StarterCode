"""This module is used to create movie objects.
Each movie takes a title, plot, poster, and YouTube trailer."""
import fresh_tomatoes
import media


# We are creating an instance of the class movie for Shaun of the Dead.
# It contains all of the info we're storing for it (title, rating, plot, etc.)
...
hot_fuzz = media.Movie(
    "Hot Fuzz",
    "An officer moves from the big city to rural England.",
...
guardians_of_the_galaxy = media.Movie(
    ...
    "http://t2.gstatic.com/images?q=tbn:ANd9GcQW3LbpT94mtUG1PZIIzJNxmFX399wr_NcvoppJ82k7z99Hx6in",  # noqa
    "https://www.youtube.com/watch?v=d96cjJhvlMA")

# Creating an instance of the movie Kingsman: The Secret Service
kingsman = media.Movie(
    "Kingsmen: The Secret Service",
    "A teen is picked by an organization that fights threats.",
    "http://t3.gstatic.com/images?q=tbn:ANd9GcTn2E6bqcLehK92h215qFnUpCYFqt02Iuwg-N4gVBmixzAXvGfZ",  # noqa
    "https://www.youtube.com/watch?v=m4NCribDx4U")

# Creating an instance of the movie Goodfellas
goodfellas = media.Movie(
    "Goodfellas",
    "A tale about the rise and fall of gangster Henry Hill.",
    "https://ae01.alicdn.com/kf/HTB1rE0TSXXXXXbYXVXXq6xXFXXXZ/DIY-frame-font-b-GOODFELLAS-b-font-CLASSIC-font-b-MOVIE-b-font-font-b-POSTER.jpg",  # noqa
